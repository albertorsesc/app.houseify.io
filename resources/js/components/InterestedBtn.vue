...
<!--        </svg>-->
        <svg class="h-5 w-5" :class="isInterested ? 'text-red-400' : 'text-gray-300'" xmlns="http://www.w3.org/2000/svg" :fill="isInterested ? 'red' : 'none'" viewBox="0 0 24 24" stroke="currentColor">
