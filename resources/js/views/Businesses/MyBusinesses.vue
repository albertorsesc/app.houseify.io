    ...
    <div>
        <div class="items-center flex justify-center">
            <svg v-show="menuTab === 'my-businesses'"
                 @click="toggle"
                 class="h-transform h-transition cursor-pointer h-6 w-6 text-emerald-300 hover:h-10 hover:w-10 hover:text-emerald-400 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <svg v-show="menuTab === 'new-business'"
                 @click="toggle"
                 class="h-transform h-transition cursor-pointer h-6 w-6 text-emerald-300 hover:h-10 hover:w-10 hover:text-emerald-400 "
        ...
        <div v-if="myBusinesses.length === 0" class="flex-wrap md:flex sm:justify-center p-6 mt-3 items-center rounded-lg">
...
&lt;!&ndash;                    <p class="mb-8 mt-4">Tus Negocios .</p>&ndash;&gt;
                </div>
...
<!--                    <p class="text-2xl md:text-3xl font-light leading-normal">Crea tu Negocio. </p>-->
