@props(['title' => __('Confirm Password'), 'content' => __('Por seguridad de la cuenta, confirme su contraseña para continuar.'), 'button' => __('Confirmar')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="footer">
        ...
        <button class="ml-2 h-btn-success"
